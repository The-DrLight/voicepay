...
// Intron Sahara WebSocket STT. No longer the primary voice input (see
// useVoiceCommand.js, which now uses the browser's SpeechRecognition API) —
// kept here so it can still be swapped in for benchmark comparisons.
//
...
const SILENCE_THRESHOLD = 0.015; // RMS energy below this counts as silence
const SILENCE_DURATION_MS = 2800; // stop after this much continuous silence
const MIN_SPEECH_DURATION_MS = 2000; // ignore silence during the opening beat
...
export function useSaharaVoiceCommand({ onTranscript } = {}) {
